...
types = c(0,0,1,1,1,0,1,1,1,0,0,1,1,0)
...
# Scraping
BASE_URL = "https://auburntigers.com"
years = 2013:2023
...
for (i in 1:nrow(sports_df)) {
  ...
  for (y in 1:length(years)) {
    ...
    if (sport %in% c("xctrack", "swimming-and-diving")) {
...
write.csv(college_df, "AUBURN.csv", row.names=F)