...
We get as many cities as we can that have available census data.
...
Let's plot the top 50 towns, and see where they land on the map in accordance with the players.
